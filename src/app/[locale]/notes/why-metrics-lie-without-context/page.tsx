...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const meta = createPageMetadata({
    locale,
    path: '/notes/why-metrics-lie-without-context',
    title: t('posts.why-metrics-lie-without-context.title'),
    description: t('posts.why-metrics-lie-without-context.excerpt'),
  });
  return {
    ...meta,
    openGraph: {
...
export default async function BlogPost({
  ...
  const postUrl = locale === 'it' ? `${baseUrl}/it/notes/why-metrics-lie-without-context` : `${baseUrl}/notes/why-metrics-lie-without-context`;
