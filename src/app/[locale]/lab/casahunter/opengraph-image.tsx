...
export const alt = 'CasaHunter - Mattia De Luca';
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', flex: 1, justifyContent: 'center' }}>
          ...
          >
            AI-powered apartment hunting tool
          </p>
          ...
          >
            Three-pass scoring system: 80% deterministic filtering, 20% AI budget on what matters. 880+ listings analyzed, zero manual search.
          </div>
        </div>
