...
export default async function CasaHunterPage({
  ...
  const contextParagraphs = t.raw('casahunter.context.content') as string[];
  const challengeParagraphs = t.raw('casahunter.challenge.content') as string[];
    ...
    <>
      ...
      <Section>
        ...
        >
          ...
          {/* What I learned */}
          <h2 className="mt-16">{t('casahunter.learned.heading')}</h2>
