...
export const alt = 'Leadsbridge Redesign - Mattia De Luca';
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', flex: 1, justifyContent: 'center' }}>
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            >
              Setup time reduction across 380+ integrations
            </div>
          </div>
          ...
          >
            B2B SaaS integration platform with direct partnerships with Meta, Google, LinkedIn, and TikTok. The core flow was also the weakest point.
          </div>
        </div>
