...
export const alt = 'Cashless System - Mattia De Luca';
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', flex: 1, justifyContent: 'center' }}>
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            >
              Zero to live demo for cashless integration
            </div>
          </div>
          ...
          >
            Killing the obvious option to find the structural solution. Working with real constraints to define the right strategy.
          </div>
        </div>
