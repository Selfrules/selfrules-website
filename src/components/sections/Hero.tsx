  ...
  return (
    ...
    >
      <div className="max-w-[720px]">
        ...
        {/* Headline */}
        <h1 className="font-heading text-[clamp(40px,5vw,64px)] font-bold leading-[1.1] text-text-primary">
          {headline}
        </h1>

        {/* Subtitle with blinking cursor */}
        <p className="text-base leading-[1.7] text-text-secondary max-w-[600px] mt-4">
          {subtitle}
