  ...
  return (
    <figure className="not-prose my-12">
      ...
      >
        ...
        <text x="300" y="94" textAnchor="middle" fontFamily="JetBrains Mono, monospace" fontSize="9" fill="rgba(255,255,255,0.55)">&quot;DAU up 23%&quot;</text>
        ...
        <text x="300" y="192" textAnchor="middle" fontFamily="JetBrains Mono, monospace" fontSize="9" fill="rgba(255,255,255,0.55)">All three required</text>

        {/* Edge labels */}
        <text x="175" y="120" textAnchor="middle" fontFamily="JetBrains Mono, monospace" fontSize="8" fill="rgba(255,255,255,0.55)" transform="rotate(-42, 175, 120)">push notifications</text>
        <text x="425" y="120" textAnchor="middle" fontFamily="JetBrains Mono, monospace" fontSize="8" fill="rgba(255,255,255,0.55)" transform="rotate(42, 425, 120)">3x opt-out rate</text>
        <text x="300" y="232" textAnchor="middle" fontFamily="JetBrains Mono, monospace" fontSize="8" fill="rgba(255,255,255,0.55)">caused by → traded off by</text>
      </svg>
    </figure>
  );
}
