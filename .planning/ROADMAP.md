...
- [x] 04-03-PLAN.md — page.tsx translation orchestrator wiring all 6 sections, visual verification checkpoint
...
- [x] 05-04-PLAN.md — Blog listing page + Blog post with MDX content, visual verification checkpoint
