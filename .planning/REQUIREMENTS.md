...
- [ ] **PAGE-02**: Work page with headline + intro, 2 CaseStudyCards (1 with [BOZZA] note), CTA
- [ ] **PAGE-03**: Lab page with headline + intro, CasaHunter ProjectCard with full detail, "Prossimamente" MoneyMind, CTA
...
- [ ] **SEO-01**: Meta title + description per page from source files
- [ ] **SEO-02**: Open Graph tags (og:title, og:description, og:url, og:type, og:locale) per page
- [ ] **SEO-03**: Canonical URLs per page
- [ ] **SEO-04**: hreflang alternate tags (bidirectional + x-default) for IT ↔ EN
- [ ] **SEO-05**: JSON-LD structured data: Person schema (About), BreadcrumbList (navigation)
- [ ] **SEO-06**: sitemap.xml and robots.txt generated by Next.js
- [ ] **SEO-07**: Correct `<html lang>` attribute based on locale
